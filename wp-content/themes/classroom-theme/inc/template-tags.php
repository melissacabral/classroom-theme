...
/**
 * TODO: finish this TODAY date function
 */
function classroom_theme_posted_on(){
...
if ( ! function_exists( 'classroom_theme_posted_on' ) ) :
/**
...
function classroom_theme_posted_on() {
	...
	$posted_on = sprintf(
		_x( 'Posted on %s', 'post date', 'classroom-theme' ),
		'<a href="' . esc_url( get_permalink() ) . '" rel="bookmark">' . $time_string . '</a>'
	);

	$byline = sprintf(
		_x( 'by %s', 'post author', 'classroom-theme' ),
